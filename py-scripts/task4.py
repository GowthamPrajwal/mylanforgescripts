...
parser.add_argument('--ssid', type=str, help= 'ssid name', default="OpenWifi-5g")
parser.add_argument('--psswd', type=str, help= 'password', default="OpenWifi")
...
parser.add_argument('--mgr', type=str, help= 'Lanforge ip', default="192.168.200.237")
parser.add_argument('--radio', type=str, help= 'radio',default="phy1")
